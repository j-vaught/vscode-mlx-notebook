...
### Added
- Motivation section in README
- Configurable test fixture path via environment variable

### Fixed
- Remove hardcoded local path from test suite
- Remove stale LaTeX rendering limitation from README (already supported)
